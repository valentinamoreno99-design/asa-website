...
export function ContactForm() {
  ...
  return (
    <form onSubmit={onSubmit} className="border-t border-rule-invert pt-2">
      ...
      {state === "error" ? (
        <p className="type-meta mt-6 text-light-blue">{error}</p>
      ) : null}

      <button
        type="submit"
        disabled={state === "sending"}
        className="type-label mt-10 bg-asa-blue px-8 py-5 transition-colors hover:bg-background hover:text-navy disabled:opacity-60"
      >
